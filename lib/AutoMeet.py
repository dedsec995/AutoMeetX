...
class AutoMeet():
    ...
    def automeetX(self):
        ...
        while True:
            ...
            text = self.browser.find_element_by_xpath("/html/body/div[1]/c-wiz/div[1]/div/div[4]/div[3]/div[3]/div/div[2]/div[2]/div[2]/span[2]/div/div[1]").text
            people = self.browser.find_element_by_xpath("/html/body/div[1]/c-wiz/div[1]/div/div[4]/div[3]/div[3]/div/div[2]/div[2]/div[1]/div[1]").text
            # print(people)
            # print(text)
            final_text = text.replace(text_temp,"")
            # print(final_text)
            text_temp = text
            link = re.findall(r"(http|ftp|https)://([\w-]+(?:(?:.[\w-]+)+))([\w.,@?^=%&:/~+#-]*[\w@?^=%&/~+#-])?",final_text)
